    ...
    commands
        .spawn((
            ...
            Camera {
                ...
                order: -1,
                target: RenderTarget::from(image_handle),
...
fn render_to_image_example_system(
    ...
    let preview_material_handle = preview_cube_query.single().expect("No preview cube found");
    ...
    if apply {
        ...
        let main_material_handle = main_cube_query.single().expect("No main pass cube found");
